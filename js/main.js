...
console.log('*** JSnack 4 (Bonus) in corso ***');
var array = [];
for( i=0 ; i<10 ; i++ ) {
    array.push(Math.ceil(Math.random()*256));
}
console.log('I numeri interi generati sono: ');
console.table(array);
console.log('I numeri interi in posizione dispari (es index 1,3,5,7,9...) sono: ');
sum = 0;
...
console.log('Il loro totale è: ' + sum);
console.log('*** JSnack 4 completato ***');
console.log('---------------------------------------------------------');